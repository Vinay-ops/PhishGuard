...
function normalizeAnalysisResult(data) {
  return {
    ...
    mlPhishingProbabilityPct: data.ml_phishing_probability_pct ?? data.confidence ?? 0,
    modelRuleStatus: data.model_rule_status ?? null,
    ...
    whyFlagged: data.why_flagged ?? null,
...
function normalizeHistoricalRecord(record) {
  ...
  return {
    ...
    mlPhishingProbabilityPct: securityAnalysis.ml_phishing_probability_pct ?? record.confidence ?? 0,
    modelRuleStatus: securityAnalysis.model_rule_status ?? null,
    message: record.message ?? '',
    detectedIndicators,
    ...
    whyFlagged: securityAnalysis.why_flagged ?? null,
